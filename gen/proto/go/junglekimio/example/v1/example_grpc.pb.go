...
func (c *exampleServiceClient) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/junglekimio.example.v1.ExampleService/HealthCheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *exampleServiceClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/junglekimio.example.v1.ExampleService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ExampleService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/junglekimio.example.v1.ExampleService/HealthCheck",
	}
...
func _ExampleService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/junglekimio.example.v1.ExampleService/Hello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ExampleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "junglekimio.example.v1.ExampleService",
	...
	Metadata: "junglekimio/example/v1/example.proto",
}
